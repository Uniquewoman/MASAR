...
{ topic: JRN, difficulty: 'hard', type: 'code',
  ...
  options: ['احتكاك نافع في الرحلة يحمي العميل', 'احتكاك ضار يعطّله بلا سبب', 'خطوة زائدة تُحذَف فوراً', 'عيب في التصميم يجب إصلاحه'],
  correct_answer: 0,
...
{ topic: JRN, difficulty: 'hard', type: 'code',
  ...
  options: ['احتكاك ضار يُحذَف من الرحلة', 'احتكاك نافع في الرحلة يحمي العميل', 'حقل لازم للالتزام النظامي', 'تحسين في تجربة المستخدم'],
  correct_answer: 0,
